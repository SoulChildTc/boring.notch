...
class BoringNotchSkyLightWindow: NSPanel {
    ...
    override var canBecomeKey: Bool { MainActor.assumeIsolated { BoringViewCoordinator.shared.currentView == .scratchpad } }
    override var canBecomeMain: Bool { MainActor.assumeIsolated { BoringViewCoordinator.shared.currentView == .scratchpad } }
}
